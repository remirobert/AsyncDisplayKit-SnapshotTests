#
# Be sure to run `pod lib lint AsyncDisplayKit-SnapshotTests.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AsyncDisplayKit-SnapshotTests'
  s.version          = '0.1.0'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'AsyncDisplayKit-SnapshotTests' => ['AsyncDisplayKit-SnapshotTests/Assets/*.png']
  # }
